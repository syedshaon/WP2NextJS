...
const WorkTogether = () => {
  return (
    <div className="container animate-in slide-in-from-bottom-60 duration-500 mx-auto relative h-[40vh] overflow-hidden flex justify-center items-center flex-col gap-3 mb-10">
      ...
      <h3 className="text-white lg:w-2/3 text-2xl lg:text-5xl font-bold  font-jakartaSans text-center container ">Let’s Work Together on YourNext Project</h3>
      <p className=" m-3 lg:my-5 text-white text-base lg:text-lg container text-center lg:w-1/2 ">Frustrated by a slow website? We’ll help you tame those speed demons so you can keep visitors coming back for more!</p>
