...
const Partners = () => {
  return (
    <div className="animate-in zoom-in-75 duration-500 my-20">
      <h3 className=" container text-2xl lg:w-2/3 mb-10 text-center mx-auto font-semibold  font-jakartaSans  ">Showcasing Our Valued Partners: A Comprehensive Display of Collaboration and Mutual Success</h3>
