...
const Team = () => {
  return (
    <div className=" container my-20">
      <h3 className="animate-in slide-in-from-bottom-60 duration-500 text-5xl lg:w-2/3 mb-10 text-center mx-auto font-bold  font-jakartaSans  ">Meet the Trailblazers Driving Our Success</h3>
