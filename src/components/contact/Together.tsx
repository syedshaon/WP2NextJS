...
const Together = () => {
  return (
    <div className="animate-in slide-in-from-bottom-60 duration-500 container mx-auto relative z-20 h-[40vh] overflow-hidden flex justify-center items-center flex-col gap-3 mb-10">
      ...
      <h3 className="text-white lg:w-2/3 text-2xl lg:text-4xl font-bold  font-jakartaSans text-center container bg-[rgba(0,0,0,.5)]">Let’s Work Together on YourNext Project</h3>
